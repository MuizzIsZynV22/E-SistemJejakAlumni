    ...
    <section class="flex flex-col md:flex-row p-2 items-center justify-center min-h-screen bg-gray-100">
        ...
        <div class="md:w-2/3 bg-orange-100 p-8 rounded-lg shadow-lg m-4">
            ...
            <form method="post" action="./backend/alumni.php" class="space-y-4">
                ...
                <div>
                    <label for="nama_alumni" class="block text-gray-700 font-semibold">Nama</label>
                    <input type="text" id="nama_alumni" name="nama_alumni" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
                ...
                <div>
                    <label for="password_alumni_confirm" class="block text-gray-700 font-semibold">Sahkan Kata Laluan</label>
                    <input type="password" id="password_alumni_confirm" name="password_alumni_confirm" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>

                <br><br>

                <div class="text-center">
                    <button type="submit" name="daftar_alumni" class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600">Daftar</button>
