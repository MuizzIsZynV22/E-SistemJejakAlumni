    ...
    <section class="bg-orange-100 py-8">
        <div class="container mx-auto text-center">
            <div class="bg-orange-300 p-6 rounded-lg inline-block drop-shadow px-40">
                <h2 class="text-xl font-bold">Arif Shah</h2><br>
                ...
                <div class="mt-4">
                    <a href="./userinfo_bekerja.php" class="bg-blue-500 text-white px-4 py-2 rounded-lg mr-2 hover:bg-blue-600">Periksa</a>
                    <a href="./index.php" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600">Log Keluar</a>
                </div>
            </div>
        </div>
    </section>
