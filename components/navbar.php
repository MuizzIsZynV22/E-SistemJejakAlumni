<nav class="bg-white border-b border-blue-900 dark:bg-white">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="index.php" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="src/img/kvks.png" class="h-10" alt="KVKS Logo" />
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
      <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-white md:dark:bg-white dark:border-gray-700">
        <li>
          <a href="./index.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-800 md:p-0 dark:text-blue-600 md:dark:hover:text-blue-600 dark:hover:bg-gray-700 dark:hover:underline md:dark:hover:bg-transparent">Utama</a>
        ...
        <li>
          <a href="./statistic.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-800 md:p-0 dark:text-blue-600 md:dark:hover:text-blue-600 dark:hover:bg-gray-700 dark:hover:underline md:dark:hover:bg-transparent">Statistik</a>
        </li>
        <li>
          <a href="./signin.php" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-green-800 md:p-0 dark:text-blue-600 md:dark:hover:text-blue-600 dark:hover:bg-gray-700 dark:hover:underline md:dark:hover:bg-transparent">Log Masuk</a>
        </li>
      </ul>
    </div>
  </div>
